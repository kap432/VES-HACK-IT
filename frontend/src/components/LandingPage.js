...
<div id="signup_work">
  ...
  <div class="how_content"><span style={{ fontWeight: "bold" }}>Sign Up:</span> Create your account.</div>
</div>

<div id="choose_game">
<div class="how_content"><span style={{ fontWeight: "bold" }}>Choose Your Game:</span> <br></br>
Pick what you want to play.</div>
...
<div id="play_n_enjoy">
  ...
  <div class="how_content"><span style={{ fontWeight: "bold" }}>Play & Enjoy:</span> Start having fun!</div>
</div>

<div id="track_progress">
<div class="how_content"><span style={{ fontWeight: "bold" }}>Track Your Progress:</span><br></br>
See how you’re doing.</div>
